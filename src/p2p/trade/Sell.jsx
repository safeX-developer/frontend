...
import SellMedal from "./modal/SellModal"
...
export default function Sell() {
  ...
  return (
    <>
    {modal ? <SellMedal handleCancelMedal={()=> setModal(false)}/> : ""}
        ...
        <div className="trade-table__wrapper">
            <div className="nt-spin-nested-loading trade-table__spin css-7o12g0">
                <div className="ant-spin-container">
                    ...
                    <table>
                        <thead><tr><th>Advertiser</th><th>Price</th><th>Available<span className="delimiter">|</span>Limits</th><th>Payment Method</th><th><div className="moly-tag whitespace-nowrap font-medium inline-flex items-center gap-1 rounded data-[disabled]:text-base-bds-gray-t4-dis data-[disabled]:bg-base-bds-gray-ele-edge data-[disabled]:cursor-not-allowed text-xs leading-[18px] h-[18px] ps-[4px] pe-[4px] bg-brandColor-bds-brand-100-bg text-brandColor-bds-brand-900-text">Taker 0 Transaction Fees</div></th></tr></thead>
                        <tbody className="trade-table__tbody">
                            {thHuish.map((item)=> (
                                ...
                                <td className="trade-list-action-button">
                                    <button onClick={()=> setModal(true)} type="button" className="ant-btn css-7o12g0 ant-btn-primary css-7o12g0 ant-btn-custom ant-btn-custom-sm ant-btn-custom-tradeShort bds-theme-component-light">
                                        <span>Sell USDT</span>
                                    </button>
                                </td>
                            </tr>
