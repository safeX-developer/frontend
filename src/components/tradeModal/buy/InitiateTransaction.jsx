...
function InitiateTransaction({
  ...
  const handleSubmit = () => {
    navigate("?modal=buy&tab=pay-now");
  };
        ...
        <div className="mt-4 bg-[#1a1a1a] rounded-lg p-4">
          ...
          {activeTab === 'fiat' && (
            <div>
              ...
              <button 
                ...
                className="w-full bg-[var(--active)] text-white py-2 rounded-md hover:opacity-90 transition-opacity text-sm font-medium cursor-pointer"
              >
                Proceed
              </button>
          ...
          {activeTab === 'crypto' && (
            <div>
              ...
              {/* Proceed button */}
              <button 
                onClick={onProceed || handleSubmit} 
                className="w-full bg-[var(--active)] text-white py-2 rounded-md hover:opacity-90 transition-opacity text-sm font-medium cursor-pointer"
              >
                Proceed
              </button>
