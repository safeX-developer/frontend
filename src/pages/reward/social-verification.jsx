  ...
  return (
   <div className='task-page'>  
        <div className="task-items">
            {tasks.map((item)=>(
                <div key={item.id} className={`jKSJeljsl ${item.isClaimed ? "" : "active"}`}>
                    <div className='right'>
                        <div className="icon">
                    ...
                    {item.isClaimed ? 
                    <div className='checked imgElosm'>
                        <img src="/asset/checked.png" alt="" />     
                    </div>
                    :
                        <button disabled={!item.canClaim} className='claim-btn'>{item.isClaimed ? "" :  "Start"}</button>
                    }
                </div>
            ))}
        </div>
