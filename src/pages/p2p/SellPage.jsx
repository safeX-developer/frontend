...
export default function SellPage() {
    ...
    // Fetch sell ads when component mounts
    useEffect(() => {
        fetchSellAds();
    ...
    const handleAdUpdate = (event) => {
        ...
        // Only process sell ads
        if (updatedAd.type === 'sell') {
            fetchSellAds(); // Refresh the entire list
        }
    };
    ...
    // Fetch sell ads from the socket service
    ...
    // Open sell modal with selected listing
