                                        ...
                                        <div class="itemContent">
                                            <div class="paymentItemHeader">
                                                <label class="ant-checkbox-wrapper css-5jb6ku ant-checkbox-custom ant-checkbox-custom-sm bds-theme-component-light css-5jb6ku">
                                                    <span onClick={handleChecked} class={`ant-checkbox css-5jb6ku ${checked ? "ant-checkbox-checked" : ""}`}>
                            ...
                            <div class="footCustom">
                                <div class="ant-space css-5jb6ku ant-space-horizontal ant-space-align-center btnWrapper" style={{gap: "16px"}}>
                                    <div class="ant-space-item" >
                                        <button type="button" class="ant-btn css-5jb6ku ant-btn-primary css-5jb6ku ant-btn-custom ant-btn-custom-middle ant-btn-custom-primary bds-theme-component-light" disabled={!checked}>
                                            <span>Confirm</span>
                                        </button>
                                    </div>
                                    <div class="ant-space-item">
                                        <button onClick={handleCancel} type="button" class="ant-btn css-5jb6ku ant-btn-default css-5jb6ku ant-btn-custom ant-btn-custom-middle bds-theme-component-light">
                                            <span>Cancel</span>
                                        </button>
                                    </div>
                                </div>
